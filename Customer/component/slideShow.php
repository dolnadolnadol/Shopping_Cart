...
<style>
    ...
    .slideshow-container {
        ...
        position: relative;
        margin: auto;
        height: 200px; /* Set a fixed height for the slideshow container */
    }
    ...
    .mySlides {
        display: none;
        width: 100%;
        height: 100%; /* Set images to fill the container */
        object-fit: cover; /* Ensure the aspect ratio is maintained while covering the container */
    }
