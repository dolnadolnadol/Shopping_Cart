    ...
    if (mysqli_num_rows($msresults) > 0) {
        while ($row = mysqli_fetch_array($msresults)) {
            echo "<tr class='user-row'>
                    <td><input type='checkbox' name='checkbox[]' value='{$row['typeId']}'></td>
                    <td>{$row['typeId']}</td>
                    <td>{$row['typeName']}</td>
                    <td>";
                    if ($row['hide'] == 0) {
                    ...
                    echo "</td>
                    <td>
                        <form class='action-button' action='type_update.php' method='post' style='display: inline-block;'>  
                            <input type='hidden' name='id_type' value={$row['typeId']}>
                            <input type='image' alt='update' src='../img/pencil.png'/>
                        </form>
                        <form class='action-button' action='type_delete.php' method='post' style='display: inline-block;'>
                            <input type='hidden' name='id_type' value={$row['typeId']}>
                            <input type='image' alt='delete' src='../img/hide.png'/>
                        </form>
                    </td>
                </tr>";
        } 
